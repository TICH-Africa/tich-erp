...
CREATE TABLE IF NOT EXISTS `assets` (
  ...
  `asset_status` varchar(50) NOT NULL DEFAULT 'new',
  `handover_date` date DEFAULT NULL,
  `grn_id` bigint(20) unsigned DEFAULT NULL,
  `procurement_requisition_id` bigint(20) unsigned DEFAULT NULL,
...
CALL `tich_ensure_column`('assets', 'tag_number', 'varchar(50) NULL DEFAULT NULL');
CALL `tich_ensure_column`('assets', 'qr_code_path', 'varchar(500) NULL DEFAULT NULL');
CALL `tich_ensure_column`('assets', 'custodian_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('assets', 'location_name', 'varchar(255) NULL DEFAULT NULL');
CALL `tich_ensure_column`('assets', 'building', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('assets', 'room', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('assets', 'asset_status', 'varchar(50) NOT NULL DEFAULT \'\\\'new\\\'\'');
CALL `tich_ensure_column`('assets', 'handover_date', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('assets', 'grn_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('assets', 'procurement_requisition_id', 'bigint(20) unsigned NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('asset_audits', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('asset_audits', 'asset_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('asset_audits', 'auditor_id', 'bigint(20) unsigned NOT NULL');
...
CALL `tich_ensure_column`('asset_audits', 'notes', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_audits', 'photo_paths', 'longtext NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_audits', 'submitted_at', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_audits', 'reviewed_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_audits', 'reviewed_at', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_audits', 'review_notes', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_audits', 'status', 'varchar(50) NOT NULL DEFAULT \'\\\'pending\\\'\'');
CALL `tich_ensure_column`('asset_audits', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_audits', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('asset_disposals', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('asset_disposals', 'asset_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('asset_disposals', 'disposal_type', 'varchar(50) NOT NULL DEFAULT \'\\\'write_off\\\'\'');
CALL `tich_ensure_column`('asset_disposals', 'disposal_date', 'date NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('asset_disposals', 'disposal_details', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_disposals', 'requested_by', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('asset_disposals', 'approved_by', 'bigint(20) unsigned NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('asset_disposals', 'approved_at', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_disposals', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_disposals', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('asset_maintenance', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('asset_maintenance', 'asset_id', 'bigint(20) unsigned NOT NULL');
...
CALL `tich_ensure_column`('asset_maintenance', 'scheduled_date', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_maintenance', 'completed_date', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_maintenance', 'work_done', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_maintenance', 'parts_used', 'longtext NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('asset_maintenance', 'technician_name', 'varchar(200) NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_maintenance', 'technician_phone', 'varchar(30) NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_maintenance', 'attachment_paths', 'longtext NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_maintenance', 'completed_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_maintenance', 'status', 'varchar(50) NOT NULL DEFAULT \'\\\'pending\\\'\'');
CALL `tich_ensure_column`('asset_maintenance', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_maintenance', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('asset_movements', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('asset_movements', 'asset_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('asset_movements', 'from_location', 'varchar(255) NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_movements', 'to_location', 'varchar(255) NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('asset_movements', 'requested_by', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('asset_movements', 'approved_by', 'bigint(20) unsigned NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('asset_movements', 'movement_date', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_movements', 'approved_at', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_movements', 'notes', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_movements', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('asset_movements', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('finance_policies', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
...
CALL `tich_ensure_column`('finance_policies', 'version', 'varchar(50) NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policies', 'file_path', 'varchar(500) NOT NULL');
CALL `tich_ensure_column`('finance_policies', 'description', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policies', 'effective_date', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policies', 'status', 'varchar(50) NOT NULL DEFAULT \'\\\'draft\\\'\'');
CALL `tich_ensure_column`('finance_policies', 'uploaded_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policies', 'uploaded_at', 'datetime NOT NULL DEFAULT current_timestamp()');
CALL `tich_ensure_column`('finance_policies', 'published_at', 'datetime NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policies', 'created_at', 'datetime NOT NULL DEFAULT current_timestamp()');
CALL `tich_ensure_column`('finance_policies', 'updated_at', 'datetime NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('finance_policy_signoffs', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('finance_policy_signoffs', 'policy_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('finance_policy_signoffs', 'policy_version', 'varchar(50) NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policy_signoffs', 'signed_role', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policy_signoffs', 'department_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('finance_policy_signoffs', 'staff_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('finance_policy_signoffs', 'user_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policy_signoffs', 'signed_name', 'varchar(200) NOT NULL');
CALL `tich_ensure_column`('finance_policy_signoffs', 'employee_number', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policy_signoffs', 'signature', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('finance_policy_signoffs', 'ip_address', 'varchar(64) NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('grn_items', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('grn_items', 'grn_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('grn_items', 'purchase_order_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('grn_items', 'supplier_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('grn_items', 'item_name', 'varchar(300) NOT NULL');
CALL `tich_ensure_column`('grn_items', 'item_description', 'varchar(500) NULL DEFAULT NULL');
CALL `tich_ensure_column`('grn_items', 'category', 'varchar(50) NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('grn_items', 'received_date', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('grn_items', 'status', 'varchar(50) NOT NULL DEFAULT \'\\\'pending\\\'\'');
CALL `tich_ensure_column`('grn_items', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('grn_items', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('me_policy_signoffs', 'policy_version', 'varchar(50) NULL DEFAULT NULL');
CALL `tich_ensure_column`('me_policy_signoffs', 'signed_role', 'varchar(100) NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('procurement_invoices', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('procurement_invoices', 'invoice_number', 'varchar(50) NOT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'supplier_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'purchase_order_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'rfq_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'requisition_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'invoice_date', 'date NOT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'due_date', 'date NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('procurement_invoices', 'payment_certificate', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'notes', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'created_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'matched_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'matched_at', 'datetime NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'paid_at', 'datetime NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_invoices', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('procurement_payments', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('procurement_payments', 'invoice_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('procurement_payments', 'payment_number', 'varchar(50) NOT NULL');
CALL `tich_ensure_column`('procurement_payments', 'supplier_id', 'bigint(20) unsigned NOT NULL');
...
CALL `tich_ensure_column`('procurement_payments', 'payment_reference', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_payments', 'transaction_channel_ref', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_payments', 'status', 'varchar(50) NOT NULL DEFAULT \'\\\'pending\\\'\'');
CALL `tich_ensure_column`('procurement_payments', 'mpesa_stk_request_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_payments', 'recorded_by', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('procurement_payments', 'payment_date', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_payments', 'notes', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_payments', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_payments', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('procurement_requisitions', 'quantity', 'decimal(12,2) NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_requisitions', 'budget_code', 'varchar(50) NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_requisitions', 'budget_line', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_requisitions', 'delivery_required_by', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('procurement_requisitions', 'delivery_location', 'varchar(500) NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('procurement_requisitions', 'audit_trail', 'text NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('qa_certification_reminders', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('qa_certification_reminders', 'staff_id', 'bigint(20) unsigned NOT NULL');
...
CALL `tich_ensure_column`('qa_certification_reminders', 'reminder_sent_at', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_certification_reminders', 'escalation_sent_at', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_certification_reminders', 'is_expired', 'tinyint(1) NOT NULL DEFAULT \'0\'');
CALL `tich_ensure_column`('qa_certification_reminders', 'raised_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_certification_reminders', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_certification_reminders', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('qa_training_credits', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('qa_training_credits', 'staff_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('qa_training_credits', 'credit_type', 'varchar(30) NOT NULL');
CALL `tich_ensure_column`('qa_training_credits', 'credit_value', 'int(10) unsigned NOT NULL');
CALL `tich_ensure_column`('qa_training_credits', 'event_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_credits', 'awarded_at', 'date NOT NULL');
CALL `tich_ensure_column`('qa_training_credits', 'expires_at', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_credits', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_credits', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('qa_training_event_enrolments', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('qa_training_event_enrolments', 'qa_capacity_session_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('qa_training_event_enrolments', 'staff_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('qa_training_event_enrolments', 'status', 'varchar(30) NOT NULL DEFAULT \'\\\'pending\\\'\'');
CALL `tich_ensure_column`('qa_training_event_enrolments', 'decline_reason', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_enrolments', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_enrolments', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('qa_training_event_registrations', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('qa_training_event_registrations', 'qa_capacity_session_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'title', 'varchar(300) NOT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'description', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'start_at', 'datetime NOT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'end_at', 'datetime NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'provider', 'varchar(200) NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'location', 'varchar(300) NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'credit_type', 'varchar(30) NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'credit_value', 'int(10) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'target_audience', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'max_attendees', 'int(10) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'enrolled_count', 'int(10) unsigned NOT NULL DEFAULT \'0\'');
CALL `tich_ensure_column`('qa_training_event_registrations', 'status', 'varchar(30) NOT NULL DEFAULT \'\\\'open\\\'\'');
CALL `tich_ensure_column`('qa_training_event_registrations', 'created_by', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('qa_training_event_registrations', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('research_projects', 'slug', 'varchar(320) NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('research_projects', 'body', 'longtext NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('research_projects', 'duration_value', 'int(10) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('research_projects', 'duration_unit', 'varchar(20) NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('research_projects', 'published_at', 'datetime NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('research_project_documents', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('research_project_documents', 'research_project_id', 'bigint(20) unsigned NOT NULL');
...
CALL `tich_ensure_column`('research_project_documents', 'original_filename', 'varchar(300) NULL DEFAULT NULL');
CALL `tich_ensure_column`('research_project_documents', 'mime_type', 'varchar(120) NULL DEFAULT NULL');
CALL `tich_ensure_column`('research_project_documents', 'file_size', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('research_project_documents', 'sort_order', 'int(10) unsigned NOT NULL DEFAULT \'0\'');
CALL `tich_ensure_column`('research_project_documents', 'created_at', 'datetime NOT NULL DEFAULT current_timestamp()');
CALL `tich_ensure_column`('research_project_documents', 'created_by', 'bigint(20) unsigned NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('rfqs', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('rfqs', 'rfq_number', 'varchar(50) NOT NULL');
CALL `tich_ensure_column`('rfqs', 'requisition_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('rfqs', 'created_by', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('rfqs', 'item_description', 'text NOT NULL');
CALL `tich_ensure_column`('rfqs', 'quantity', 'decimal(12,2) NOT NULL');
CALL `tich_ensure_column`('rfqs', 'specifications', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'delivery_timeline', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'delivery_location', 'varchar(500) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'submission_deadline', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'minimum_categories', 'longtext NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'preferred_categories', 'longtext NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'minimum_suppliers', 'int(11) NOT NULL DEFAULT \'3\'');
CALL `tich_ensure_column`('rfqs', 'status', 'varchar(50) NOT NULL DEFAULT \'\\\'draft\\\'\'');
CALL `tich_ensure_column`('rfqs', 'award_decision', 'varchar(50) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'awarded_supplier_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'awarded_amount', 'decimal(12,2) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'approval_level', 'varchar(50) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'approval_status', 'varchar(50) NOT NULL DEFAULT \'\\\'pending\\\'\'');
CALL `tich_ensure_column`('rfqs', 'approved_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'approved_at', 'datetime NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'approval_notes', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'award_letter_path', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'published_at', 'datetime NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfqs', 'closed_at', 'datetime NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('rfq_clarifications', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('rfq_clarifications', 'rfq_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('rfq_clarifications', 'supplier_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_clarifications', 'asked_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_clarifications', 'question', 'text NOT NULL');
CALL `tich_ensure_column`('rfq_clarifications', 'answer', 'text NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('rfq_clarifications', 'answered_at', 'datetime NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('rfq_evaluations', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('rfq_evaluations', 'rfq_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('rfq_evaluations', 'supplier_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('rfq_evaluations', 'evaluated_by', 'bigint(20) unsigned NOT NULL');
...
CALL `tich_ensure_column`('rfq_evaluations', 'rank', 'int(11) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_evaluations', 'comments', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_evaluations', 'has_conflict_of_interest', 'tinyint(1) NOT NULL DEFAULT \'0\'');
CALL `tich_ensure_column`('rfq_evaluations', 'conflict_of_interest_details', 'text NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('rfq_quotations', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('rfq_quotations', 'rfq_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('rfq_quotations', 'supplier_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('rfq_quotations', 'submitted_by', 'bigint(20) unsigned NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('rfq_quotations', 'delivery_period', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_quotations', 'payment_terms', 'varchar(500) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_quotations', 'warranty_terms', 'varchar(500) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_quotations', 'validity_period', 'varchar(100) NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_quotations', 'technical_notes', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_quotations', 'attachments', 'longtext NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('rfq_quotations', 'revised_at', 'datetime NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_quotations', 'locked_at', 'datetime NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('rfq_suppliers', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('rfq_suppliers', 'rfq_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('rfq_suppliers', 'supplier_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('rfq_suppliers', 'invitation_status', 'varchar(50) NOT NULL DEFAULT \'\\\'invited\\\'\'');
CALL `tich_ensure_column`('rfq_suppliers', 'decline_reason', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('rfq_suppliers', 'invited_at', 'datetime NOT NULL DEFAULT current_timestamp()');
CALL `tich_ensure_column`('rfq_suppliers', 'responded_at', 'datetime NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('stock_alerts', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('stock_alerts', 'inventory_item_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('stock_alerts', 'alert_type', 'varchar(50) NOT NULL DEFAULT \'\\\'low_stock\\\'\'');
CALL `tich_ensure_column`('stock_alerts', 'current_stock', 'int(11) NOT NULL DEFAULT \'0\'');
CALL `tich_ensure_column`('stock_alerts', 'reorder_level', 'int(11) NOT NULL DEFAULT \'0\'');
CALL `tich_ensure_column`('stock_alerts', 'recommended_quantity', 'int(11) NOT NULL DEFAULT \'0\'');
CALL `tich_ensure_column`('stock_alerts', 'triggered_at', 'timestamp NOT NULL DEFAULT current_timestamp()');
CALL `tich_ensure_column`('stock_alerts', 'closed_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('stock_alerts', 'channels', 'longtext NULL DEFAULT NULL');
CALL `tich_ensure_column`('stock_alerts', 'sent_to', 'longtext NULL DEFAULT NULL');
CALL `tich_ensure_column`('stock_alerts', 'requisition_id', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('stock_alerts', 'status', 'varchar(50) NOT NULL DEFAULT \'\\\'active\\\'\'');
CALL `tich_ensure_column`('stock_alerts', 'notes', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('stock_alerts', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('stock_alerts', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('stock_issues', 'id', 'bigint(20) unsigned NOT NULL AUTO_INCREMENT');
CALL `tich_ensure_column`('stock_issues', 'inventory_item_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('stock_issues', 'department_id', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('stock_issues', 'requested_by', 'bigint(20) unsigned NOT NULL');
CALL `tich_ensure_column`('stock_issues', 'approved_by', 'bigint(20) unsigned NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('stock_issues', 'approved_at', 'date NULL DEFAULT NULL');
CALL `tich_ensure_column`('stock_issues', 'notes', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('stock_issues', 'created_at', 'timestamp NULL DEFAULT NULL');
CALL `tich_ensure_column`('stock_issues', 'updated_at', 'timestamp NULL DEFAULT NULL');
...
CREATE TABLE IF NOT EXISTS `suppliers` (
  ...
  `pin_certificate_path` varchar(500) DEFAULT NULL,
  `cr12_path` varchar(500) DEFAULT NULL,
  `audited_financial_statements_path` varchar(500) DEFAULT NULL,
  `past_contracts` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`past_contracts`)),
  `client_references` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`client_references`)),
  ...
  `is_active` tinyint(4) NOT NULL DEFAULT 1,
  `supplier_category` varchar(50) DEFAULT NULL,
  ...
  `blacklist_status` varchar(50) NOT NULL DEFAULT 'active',
  `blacklist_reason` text DEFAULT NULL,
  `blacklisted_at` datetime DEFAULT NULL,
  `blacklisted_by` bigint(20) unsigned DEFAULT NULL,
  `performance_last_updated_at` datetime DEFAULT NULL,
  `performance_updated_by` bigint(20) unsigned DEFAULT NULL,
  `notes` text DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CALL `tich_ensure_column`('suppliers', 'registration_number', 'varchar(100) NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('suppliers', 'pin_certificate_path', 'varchar(500) NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'cr12_path', 'varchar(500) NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'audited_financial_statements_path', 'varchar(500) NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'past_contracts', 'longtext NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'client_references', 'longtext NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'staff_count', 'int(11) NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'certifications', 'longtext NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('suppliers', 'supplier_category', 'varchar(50) NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'sub_category', 'varchar(100) NULL DEFAULT NULL');
...
CALL `tich_ensure_column`('suppliers', 'blacklist_reason', 'text NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'blacklisted_at', 'datetime NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'blacklisted_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'performance_last_updated_at', 'datetime NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'performance_updated_by', 'bigint(20) unsigned NULL DEFAULT NULL');
CALL `tich_ensure_column`('suppliers', 'notes', 'text NULL DEFAULT NULL');
...
CALL `tich_ensure_fk`('assets', 'assets_custodian_id_foreign', '`custodian_id`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('assets', 'assets_grn_id_foreign', '`grn_id`', 'goods_received_notes', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('assets', 'assets_procurement_requisition_id_foreign', '`procurement_requisition_id`', 'procurement_requisitions', '`id`', 'RESTRICT', 'SET NULL');
...
CALL `tich_ensure_fk`('asset_audits', 'asset_audits_asset_id_foreign', '`asset_id`', 'assets', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('asset_audits', 'asset_audits_auditor_id_foreign', '`auditor_id`', 'staff', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('asset_audits', 'asset_audits_reviewed_by_foreign', '`reviewed_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');

-- Foreign keys for `asset_disposals`
CALL `tich_ensure_fk`('asset_disposals', 'asset_disposals_approved_by_foreign', '`approved_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('asset_disposals', 'asset_disposals_asset_id_foreign', '`asset_id`', 'assets', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('asset_disposals', 'asset_disposals_requested_by_foreign', '`requested_by`', 'staff', '`id`', 'RESTRICT', 'CASCADE');

-- Foreign keys for `asset_maintenance`
CALL `tich_ensure_fk`('asset_maintenance', 'asset_maintenance_asset_id_foreign', '`asset_id`', 'assets', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('asset_maintenance', 'asset_maintenance_completed_by_foreign', '`completed_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');

-- Foreign keys for `asset_movements`
CALL `tich_ensure_fk`('asset_movements', 'asset_movements_approved_by_foreign', '`approved_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('asset_movements', 'asset_movements_asset_id_foreign', '`asset_id`', 'assets', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('asset_movements', 'asset_movements_requested_by_foreign', '`requested_by`', 'staff', '`id`', 'RESTRICT', 'CASCADE');
...
CALL `tich_ensure_fk`('finance_policies', 'finance_policies_uploaded_by_foreign', '`uploaded_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');

-- Foreign keys for `finance_policy_signoffs`
CALL `tich_ensure_fk`('finance_policy_signoffs', 'finance_policy_signoffs_department_id_foreign', '`department_id`', 'departments', '`id`', 'RESTRICT', 'RESTRICT');
CALL `tich_ensure_fk`('finance_policy_signoffs', 'finance_policy_signoffs_policy_id_foreign', '`policy_id`', 'finance_policies', '`id`', 'RESTRICT', 'RESTRICT');
CALL `tich_ensure_fk`('finance_policy_signoffs', 'finance_policy_signoffs_staff_id_foreign', '`staff_id`', 'staff', '`id`', 'RESTRICT', 'RESTRICT');
CALL `tich_ensure_fk`('finance_policy_signoffs', 'finance_policy_signoffs_user_id_foreign', '`user_id`', 'users', '`id`', 'RESTRICT', 'SET NULL');
...
CALL `tich_ensure_fk`('grn_items', 'grn_items_grn_id_foreign', '`grn_id`', 'goods_received_notes', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('grn_items', 'grn_items_purchase_order_id_foreign', '`purchase_order_id`', 'purchase_orders', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('grn_items', 'grn_items_supplier_id_foreign', '`supplier_id`', 'suppliers', '`id`', 'RESTRICT', 'CASCADE');
...
CALL `tich_ensure_fk`('procurement_invoices', 'procurement_invoices_created_by_foreign', '`created_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('procurement_invoices', 'procurement_invoices_matched_by_foreign', '`matched_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('procurement_invoices', 'procurement_invoices_purchase_order_id_foreign', '`purchase_order_id`', 'purchase_orders', '`id`', 'RESTRICT', 'RESTRICT');
CALL `tich_ensure_fk`('procurement_invoices', 'procurement_invoices_requisition_id_foreign', '`requisition_id`', 'procurement_requisitions', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('procurement_invoices', 'procurement_invoices_rfq_id_foreign', '`rfq_id`', 'rfqs', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('procurement_invoices', 'procurement_invoices_supplier_id_foreign', '`supplier_id`', 'suppliers', '`id`', 'RESTRICT', 'RESTRICT');

-- Foreign keys for `procurement_payments`
CALL `tich_ensure_fk`('procurement_payments', 'procurement_payments_invoice_id_foreign', '`invoice_id`', 'procurement_invoices', '`id`', 'RESTRICT', 'RESTRICT');
CALL `tich_ensure_fk`('procurement_payments', 'procurement_payments_mpesa_stk_request_id_foreign', '`mpesa_stk_request_id`', 'mpesa_stk_requests', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('procurement_payments', 'procurement_payments_recorded_by_foreign', '`recorded_by`', 'staff', '`id`', 'RESTRICT', 'RESTRICT');
CALL `tich_ensure_fk`('procurement_payments', 'procurement_payments_supplier_id_foreign', '`supplier_id`', 'suppliers', '`id`', 'RESTRICT', 'RESTRICT');
...
CALL `tich_ensure_fk`('qa_certification_reminders', 'qa_certification_reminders_raised_by_foreign', '`raised_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('qa_certification_reminders', 'qa_certification_reminders_staff_id_foreign', '`staff_id`', 'staff', '`id`', 'RESTRICT', 'RESTRICT');
...
CALL `tich_ensure_fk`('qa_training_credits', 'qa_training_credits_event_id_foreign', '`event_id`', 'qa_capacity_sessions', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('qa_training_credits', 'qa_training_credits_staff_id_foreign', '`staff_id`', 'staff', '`id`', 'RESTRICT', 'RESTRICT');

-- Foreign keys for `qa_training_event_enrolments`
CALL `tich_ensure_fk`('qa_training_event_enrolments', 'qa_training_event_enrolments_qa_capacity_session_id_foreign', '`qa_capacity_session_id`', 'qa_capacity_sessions', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('qa_training_event_enrolments', 'qa_training_event_enrolments_staff_id_foreign', '`staff_id`', 'staff', '`id`', 'RESTRICT', 'RESTRICT');
...
CALL `tich_ensure_fk`('research_project_documents', 'rpd_created_by_fk', '`created_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('research_project_documents', 'rpd_project_fk', '`research_project_id`', 'research_projects', '`id`', 'RESTRICT', 'CASCADE');
...
CALL `tich_ensure_fk`('rfqs', 'rfqs_approved_by_foreign', '`approved_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('rfqs', 'rfqs_awarded_supplier_id_foreign', '`awarded_supplier_id`', 'suppliers', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('rfqs', 'rfqs_created_by_foreign', '`created_by`', 'staff', '`id`', 'RESTRICT', 'RESTRICT');
CALL `tich_ensure_fk`('rfqs', 'rfqs_requisition_id_foreign', '`requisition_id`', 'procurement_requisitions', '`id`', 'RESTRICT', 'RESTRICT');

-- Foreign keys for `rfq_clarifications`
CALL `tich_ensure_fk`('rfq_clarifications', 'rfq_clarifications_asked_by_foreign', '`asked_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('rfq_clarifications', 'rfq_clarifications_rfq_id_foreign', '`rfq_id`', 'rfqs', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('rfq_clarifications', 'rfq_clarifications_supplier_id_foreign', '`supplier_id`', 'suppliers', '`id`', 'RESTRICT', 'SET NULL');

-- Foreign keys for `rfq_evaluations`
CALL `tich_ensure_fk`('rfq_evaluations', 'rfq_evaluations_evaluated_by_foreign', '`evaluated_by`', 'staff', '`id`', 'RESTRICT', 'RESTRICT');
CALL `tich_ensure_fk`('rfq_evaluations', 'rfq_evaluations_rfq_id_foreign', '`rfq_id`', 'rfqs', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('rfq_evaluations', 'rfq_evaluations_supplier_id_foreign', '`supplier_id`', 'suppliers', '`id`', 'RESTRICT', 'CASCADE');

-- Foreign keys for `rfq_quotations`
CALL `tich_ensure_fk`('rfq_quotations', 'rfq_quotations_rfq_id_foreign', '`rfq_id`', 'rfqs', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('rfq_quotations', 'rfq_quotations_submitted_by_foreign', '`submitted_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('rfq_quotations', 'rfq_quotations_supplier_id_foreign', '`supplier_id`', 'suppliers', '`id`', 'RESTRICT', 'CASCADE');

-- Foreign keys for `rfq_suppliers`
CALL `tich_ensure_fk`('rfq_suppliers', 'rfq_suppliers_rfq_id_foreign', '`rfq_id`', 'rfqs', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('rfq_suppliers', 'rfq_suppliers_supplier_id_foreign', '`supplier_id`', 'suppliers', '`id`', 'RESTRICT', 'CASCADE');
...
CALL `tich_ensure_fk`('stock_alerts', 'stock_alerts_inventory_item_id_foreign', '`inventory_item_id`', 'inventory_items', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('stock_alerts', 'stock_alerts_requisition_id_foreign', '`requisition_id`', 'procurement_requisitions', '`id`', 'RESTRICT', 'SET NULL');

-- Foreign keys for `stock_issues`
CALL `tich_ensure_fk`('stock_issues', 'stock_issues_approved_by_foreign', '`approved_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('stock_issues', 'stock_issues_department_id_foreign', '`department_id`', 'departments', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('stock_issues', 'stock_issues_inventory_item_id_foreign', '`inventory_item_id`', 'inventory_items', '`id`', 'RESTRICT', 'CASCADE');
CALL `tich_ensure_fk`('stock_issues', 'stock_issues_requested_by_foreign', '`requested_by`', 'staff', '`id`', 'RESTRICT', 'CASCADE');
...
CALL `tich_ensure_fk`('suppliers', 'suppliers_blacklisted_by_foreign', '`blacklisted_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
CALL `tich_ensure_fk`('suppliers', 'suppliers_performance_updated_by_foreign', '`performance_updated_by`', 'staff', '`id`', 'RESTRICT', 'SET NULL');
