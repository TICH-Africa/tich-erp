...
class SiteSettingsController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('marketing.site-settings.index', [
            'panel' => $panel,
    ...
    public function updateGeneral(Request $request): RedirectResponse
    {
        ...
        $this->auditService->log(
            'marketing.site_settings.general.updated',
            'site_settings',
            null,
            null,
            ['panel' => 'general'],
            'Marketing site identity settings updated',
            'success',
            $userId,
            $request
        );
        ...
        return redirect()
            ->route('marketing.site-settings.index', ['panel' => 'general'])
    ...
    public function storeSlide(Request $request): RedirectResponse
    {
        ...
        $this->auditService->log(
            'marketing.site_settings.hero_slide.created',
            'homepage_carousel_slides',
            $slide->id,
            null,
            $slide->only(['title', 'display_order']),
            'Marketing hero slide created',
            'success',
            $request->user()->id,
            $request
        );
    ...
    private function validateSlide(Request $request, ?int $ignoreId = null): array
    {
        return $request->validate([
            ...
            'image' => [$ignoreId ? 'nullable' : 'required', 'file', 'image', 'mimes:jpeg,jpg,png,gif,webp'],
        ]);
    }
