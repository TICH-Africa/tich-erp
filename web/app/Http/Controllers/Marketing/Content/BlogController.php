...
namespace App\Http\Controllers\Marketing\Content;
...
class BlogController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('marketing.content.blogs.index', [
            'posts' => $posts,
        ]);
    }
    ...
    {
        return view('marketing.content.blogs.create', [
    ...
    {
        return view('marketing.content.blogs.edit', [
            'post' => $post,
            'statuses' => ['draft', 'published', 'archived'],
        ]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('marketing.blogs.edit', $post)
    ...
    public function update(Request $request, BlogPost $post): RedirectResponse
    {
        ...
        $this->audit->log(
            'marketing.blog.updated',
            'blog_posts',
            $post->id,
            $old,
            $post->only(['title', 'status', 'featured_image_path']),
            null,
            'success',
            $request->user()?->id,
            $request
