...
class LedgerController extends Controller
{
    ...
    public function viewExcel(Request $request): StreamedResponse
    {
        $report = $this->resolveReport($request);

        return $this->exports->inlineExcel($report, $this->reports->build($report));
    }

    public function viewSpreadsheet(Request $request): View
    {
        $report = $this->resolveReport($request);
        $reportData = $this->reports->build($report);
        ...
        return $this->printDocuments->render('finance.reports.spreadsheet', [
            ...
            'excelViewUrl' => route('finance.reports.view.excel', ['report' => $report]),
