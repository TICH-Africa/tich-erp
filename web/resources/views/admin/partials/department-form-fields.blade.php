...
<div class="tich-form-group">
    ...
    <p class="tich-caption tich-mt-1">For academic departments that offer programmes, choose a parent department that has the Academics module (typically <em>Academics</em>).</p>
</div>
<div class="tich-form-group">
