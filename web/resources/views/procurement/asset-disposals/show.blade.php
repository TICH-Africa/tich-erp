...
@section('procurement-content')
    <x-page-toolbar title="Disposal request" meta="{{ $record->asset->asset_name }}">
        <x-slot:actions>
    ...
    <div class="tich-grid tich-grid--2 tich-mt-6" style="gap:1.5rem;">
        <article class="tich-card">
            ...
            <dl class="tich-dl">
                ...
                <dt>Requested by</dt><dd>{{ $record->requestedBy?->full_name ?? '-' }}</dd>
        ...
        <article class="tich-card">
            ...
            <dl class="tich-dl">
                ...
                <dt>Approved by</dt><dd>{{ $record->approvedBy?->full_name ?? '-' }}</dd>
            </dl>
        </article>
    </div>
@endsection
