...
@section('hr-content')
    <x-page-toolbar title="Edit Contract" />
                ...
                <div>
                    ...
                    <select id="campus_id" name="campus_id" class="tich-input">
                        ...
                        @foreach ($campuses as $campus)
                            <option value="{{ $campus->id }}" {{ old('campus_id', $contract->campus_id) == $campus->id ? 'selected' : '' }}>
                                {{ $campus->campus_name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select id="line_manager_id" name="line_manager_id" class="tich-input">
                        ...
                        @foreach ($staff as $manager)
                            <option value="{{ $manager->id }}" {{ old('line_manager_id', $contract->line_manager_id) == $manager->id ? 'selected' : '' }}>
