...
@section('title', 'Upload Document - ' . $staff->fullName())

@section('hr-content')
    <div class="tich-mb-8">
        <a href="{{ route('hr.staff.show', $staff) }}" class="tich-btn tich-btn-ghost">&larr; Back to staff profile</a>
    </div>

    <article class="tich-card">
        <h1 class="tich-h1 tich-mb-6">Upload Staff Document</h1>

        <form method="POST" action="{{ route('hr.staff.documents.store', $staff) }}" enctype="multipart/form-data">
            @csrf
