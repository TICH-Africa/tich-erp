...
@section('department-content')
    ...
    <div class="uf-form">
        <form method="POST" action="{{ route('marketing.blogs.store') }}" enctype="multipart/form-data" class="tich-blog-compose" data-blog-compose data-uf="ready">
            @csrf

            <div class="uf-amount-bar">
                <div>
                    <div class="uf-amount-bar__ref">Marketing · Content</div>
            ...
            <div class="uf-form-section">
                <div class="uf-section-body">
                    <div class="uf-form-actions tich-blog-compose__footer">
                        <a href="{{ route('marketing.blogs.index') }}" class="uf-btn uf-btn-secondary">Cancel</a>
