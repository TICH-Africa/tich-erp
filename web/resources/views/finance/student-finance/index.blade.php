...
@section('finance-content')
    ...
    <div class="tich-grid tich-grid--2" style="gap: 0.75rem;">
        ...
        <a href="{{ route('finance.student-finance.fee-structures.index') }}" class="tich-card tich-card--hover" style="text-decoration:none;color:inherit;">
            <h3 class="tich-h4">Fee structures</h3>
            <p class="tich-caption tich-mt-2">Programme, year, and semester fee schedules.</p>
        </a>
        <a href="{{ route('finance.student-finance.invoices.index') }}" class="tich-card tich-card--hover" style="text-decoration:none;color:inherit;">
            <h3 class="tich-h4">Invoices</h3>
            <p class="tich-caption tich-mt-2">Tuition, application, exam, graduation, and other student bills.</p>
        </a>
        <a href="{{ route('finance.student-finance.payments.index') }}" class="tich-card tich-card--hover" style="text-decoration:none;color:inherit;">
            <h3 class="tich-h4">Payments</h3>
            <p class="tich-caption tich-mt-2">M-Pesa, bank, cash, and other payment channels.</p>
        </a>
        <a href="{{ route('finance.student-finance.receipts.index') }}" class="tich-card tich-card--hover" style="text-decoration:none;color:inherit;">
            <h3 class="tich-h4">Receipts</h3>
            <p class="tich-caption tich-mt-2">Official receipts issued against student payments.</p>
        </a>
        <a href="{{ route('finance.student-finance.adjustments.index') }}" class="tich-card tich-card--hover" style="text-decoration:none;color:inherit;">
            <h3 class="tich-h4">Adjustments</h3>
            <p class="tich-caption tich-mt-2">Scholarships, bursaries, and fee waivers.</p>
        </a>
        <a href="{{ route('finance.student-finance.installment-plans.index') }}" class="tich-card tich-card--hover" style="text-decoration:none;color:inherit;">
            <h3 class="tich-h4">Installment plans</h3>
            <p class="tich-caption tich-mt-2">Structured payment plans for large balances.</p>
        </a>
        <a href="{{ route('finance.student-finance.clearance.index') }}" class="tich-card tich-card--hover" style="text-decoration:none;color:inherit;">
            <h3 class="tich-h4">Clearance</h3>
            <p class="tich-caption tich-mt-2">Fee clearance for exams, progression, and graduation.</p>
        </a>
        <a href="{{ route('finance.student-finance.milestones.index') }}" class="tich-card tich-card--hover" style="text-decoration:none;color:inherit;">
