...
@section('finance-content')
    ...
    <form method="POST" action="{{ route('finance.student-finance.installment-plans.store', ['department' => $department->id]) }}" class="tich-card tich-form-grid tich-form-grid--2">
        @csrf
        ...
        <div class="tich-form-group" style="grid-column: 1 / -1;">
            ...
            <a href="{{ route('finance.student-finance.installment-plans.index', ['department' => $department->id]) }}" class="tich-btn tich-btn-ghost" style="margin-left: 0.5rem;">Cancel</a>
        </div>
    </form>
