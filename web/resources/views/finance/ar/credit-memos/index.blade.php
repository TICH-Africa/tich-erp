...
@section('finance-content')
    <x-page-toolbar title="Credit memos" meta="Formal credits against student invoices">
        <x-slot:actions>
            <a href="{{ route('finance.ar.credit-memos.create') }}" class="tich-btn tich-btn-primary">+ Issue credit memo</a>
            <a href="{{ route('finance.ar.index') }}" class="tich-btn tich-btn-secondary">Back to AR</a>
        </x-slot:actions>
    </x-page-toolbar>
            ...
            <tbody>
                @forelse ($memos as $memo)
                    <tr>
                        ...
                        <td><a href="{{ route('finance.ar.credit-memos.show', $memo) }}" class="tich-link">View</a></td>
                    </tr>
                @empty
