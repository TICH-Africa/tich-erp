...
@section('finance-content')
    <x-page-toolbar title="Finance" meta="Student accounts, invoicing, procurement, payroll, and financial control">
        <x-slot:actions>
            <a href="{{ route('finance.student-finance.index') }}" class="tich-btn tich-btn-primary">+ New invoice</a>
        </x-slot:actions>
    </x-page-toolbar>
    ...
    <div class="tich-grid tich-grid--2">
        <div class="tich-card">
            ...
            <a href="{{ route('finance.student-finance.index') }}" class="tich-btn tich-btn-ghost">Open</a>
        </div>
        <div class="tich-card">
            ...
            <a href="{{ route('finance.ar.index') }}" class="tich-btn tich-btn-ghost">Open</a>
        </div>
        <div class="tich-card">
            ...
            <a href="{{ route('finance.ap.index') }}" class="tich-btn tich-btn-ghost">Open</a>
        </div>
        <div class="tich-card">
            ...
            <a href="{{ route('finance.gl.index') }}" class="tich-btn tich-btn-ghost">Open</a>
        </div>
        <div class="tich-card">
            ...
            <a href="{{ route('finance.budgeting.index') }}" class="tich-btn tich-btn-ghost">Open</a>
        </div>
        <div class="tich-card">
            ...
            <a href="{{ route('finance.projects-donors.index') }}" class="tich-btn tich-btn-ghost">Open</a>
        </div>
        <div class="tich-card">
            ...
            <a href="{{ route('finance.payroll-integration.index') }}" class="tich-btn tich-btn-ghost">Open</a>
        </div>
    </div>
@endsection
