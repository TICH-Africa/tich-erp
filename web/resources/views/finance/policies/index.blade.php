...
@section('finance-content')
    <x-page-toolbar title="Financial Policy" meta="Upload and publish the Financial Policy for HOD digital sign-off before annual budgets">
        <x-slot:actions>
            <a href="{{ route('finance.financial-policies.create') }}" class="tich-btn tich-btn-primary">Upload policy</a>
        </x-slot:actions>
    </x-page-toolbar>
    ...
    @if ($current)
        <article class="tich-card tich-mt-6">
            ...
            @endif
            <a href="{{ route('finance.financial-policies.show', $current) }}" class="tich-btn tich-btn-secondary tich-mt-4">Open</a>
        </article>
    @endif
                ...
                <tbody>
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td><a href="{{ route('finance.financial-policies.show', $item) }}" class="tich-link">View</a></td>
                        </tr>
                    @empty
