...
@section('title', 'Upload Financial Policy')

@section('finance-content')
    <x-page-toolbar title="Upload Financial Policy" meta="Start-of-year policy for HOD digital sign-off before annual budgets">
        <x-slot:actions>
    ...
    <div class="uf-form">
        <form method="POST" action="{{ route('finance.financial-policies.store') }}" enctype="multipart/form-data" data-uf="ready">
            @csrf

            <div class="uf-amount-bar">
                <div>
                    <div class="uf-amount-bar__ref">FIN · Policy upload</div>
                    <div class="uf-amount-bar__sum">Upload Financial Policy</div>
                </div>
            ...
            <div class="uf-form-section">
                ...
                <div class="uf-section-body">
                    ...
                    <div class="uf-field">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title', 'Financial Policy') }}" required maxlength="300" class="{{ $errors->has('title') ? 'is-invalid' : '' }}">
            ...
            <div class="uf-form-section">
                ...
                <div class="uf-section-body">
                    ...
                    <div class="uf-form-actions">
                        ...
                        <a href="{{ route('finance.financial-policies.index') }}" class="uf-btn uf-btn-secondary">Cancel</a>
                    </div>
                </div>
            </div>
