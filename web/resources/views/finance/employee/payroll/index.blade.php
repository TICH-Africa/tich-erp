...
@section('finance-content')
    ...
    <x-page-toolbar title="Payroll" meta="Monthly salary breakdown for all staff">
        <x-slot:actions>
            <a href="{{ route('finance.employee.payroll.runs.index') }}" class="tich-btn tich-btn-primary">Payroll runs</a>
            <a href="{{ route('finance.employee.payroll.settings') }}" class="tich-btn tich-btn-secondary">Tax bands &amp; rates</a>
        </x-slot:actions>
        <x-slot:filters>
            <form method="GET" action="{{ route('finance.employee.payroll.index') }}" class="tich-page-toolbar__filters-form">
                        ...
                        <tr>
                            ...
                            @if ($breakdown)
                                ...
                                <td style="white-space: nowrap;">
                                    ...
                                    >Preview</button>
                                    <a href="{{ route('finance.employee.payroll.report', ['staff_id' => $member->id]) }}" class="tich-btn tich-btn-ghost" target="_blank" rel="noopener" title="Open payslip externally">Open</a>
                                    <a href="{{ route('finance.employee.payroll.report.pdf', ['staff_id' => $member->id]) }}" class="tich-btn tich-btn-ghost" title="Download payslip">Download</a>
                                </td>
                            @else
