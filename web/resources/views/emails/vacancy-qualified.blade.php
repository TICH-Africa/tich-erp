...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="padding: 30px; background: #f9fafb;">
        ...
        <p>Congratulations! We are pleased to inform you that you have been <strong>shortlisted</strong> for the position of <strong>{{ $vacancy->job_title }}</strong> at {{ $emailBrand['short_name'] ?? 'TICH in Africa' }}.</p>
        ...
        <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <p><strong>Status:</strong> Shortlisted / Qualified</p>
        </div>

        <h3>Next Steps</h3>
        <ol>
            <li>Our HR team will contact you within <strong>2 weeks</strong> to schedule an interview</li>
