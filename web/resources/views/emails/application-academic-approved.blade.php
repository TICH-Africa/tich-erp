                    ...
                    <tr>
                        <td style="padding:32px 28px;">
                            ...
                            <p style="margin:0 0 24px;font-size:14px;line-height:1.6;color:#494c50;">
                                ...
                                your application for <strong>{{ $programName }}</strong> has been academically approved.
                                Your application letter is attached. Please pay the application fee to continue.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 24px;background:#f5f6f6;border:1px solid #e2e4e5;">
                                <tr>
                                    <td style="padding:16px 18px;font-family:Arial,sans-serif;font-size:13px;line-height:1.6;color:#494c50;">
                                        <strong>Fee structure summary</strong><br>
                                        @foreach ($feeStructureLines as $line)
                                            {{ $line }}<br>
                                        @endforeach
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 24px;background:#f5f6f6;border:1px solid #e2e4e5;">
                                <tr>
                                    <td style="padding:16px 18px;font-family:Arial,sans-serif;font-size:13px;line-height:1.6;color:#494c50;">
                                        <strong>Application fee due:</strong> KES {{ number_format($feeAmount, 2) }}<br>
