<aside class="tich-admin-sidebar" id="ict-admin-sidebar">
    ...
    <nav class="tich-admin-sidebar__nav" aria-label="ICT module navigation">
        ...
        @include('partials.navigation.sidebar-link', ['href' => route('ict.content.pages.index'), 'label' => 'Legal pages', 'icon' => 'file-text', 'active' => request()->routeIs('ict.content.pages.*'), 'badgeKey' => 'pages'])
        ...
        @include('partials.navigation.sidebar-link', ['href' => route('ict.registration-invites.index'), 'label' => 'ERP registration invites', 'icon' => 'mail', 'active' => request()->routeIs('ict.registration-invites.*'), 'badgeKey' => 'invites'])
