<article class="tich-card tich-mt-8">
    ...
    <p class="tich-caption tich-mt-2">Enter the employee's personal email address. An invitation will be sent with a secure registration link, even if they are not yet in the staff directory.</p>
