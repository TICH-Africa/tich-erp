...
@section('title', 'Lesson plan audit - Registry')
...
@section('academics-content')
    ...
    <header class="tich-dept-header">
        <h1 class="tich-h1 tich-dept-header__title">Lesson plan audit — Registry</h1>
        <p class="tich-text">Review lesson plans approved by HODs before curriculum release.</p>
    </header>
