...
@section('academics-content')
    ...
    <x-page-toolbar title="Semester workplans" meta="HOD academic workplans awaiting registrar review">
        <x-slot:filters>
            <form method="GET" class="tich-page-toolbar__filters-form">
                <select name="status" class="tich-input tich-input--compact" onchange="this.form.submit()">
                    <option value="">Awaiting registrar</option>
                ...
                <tbody>
                    @forelse ($workplans as $plan)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('departments.academics.workplans.show', array_merge($hub, ['workplan' => $plan->id])) }}" class="tich-link">Review</a>
                            </td>
                        </tr>
                    @empty
