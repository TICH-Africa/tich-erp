<aside class="tich-admin-sidebar">
    ...
    <nav class="tich-admin-sidebar__nav">
        ...
        @include('partials.navigation.sidebar-link', ['href' => route('employee.profile.edit'), 'label' => 'Update profile', 'icon' => 'clipboard-list', 'active' => request()->routeIs('employee.profile.*')])
        ...
        @include('partials.navigation.sidebar-link', ['href' => route('employee.concerns.index'), 'label' => 'Concerns & issues', 'icon' => 'shield', 'active' => request()->routeIs('employee.concerns.*')])
        @include('partials.navigation.sidebar-link', ['href' => route('employee.relations.feedback.index'), 'label' => 'My feedback', 'icon' => 'notebook', 'active' => request()->routeIs('employee.relations.feedback.*')])
