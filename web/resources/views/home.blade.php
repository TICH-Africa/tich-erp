    ...
    <section class="tich-hero">
        <div class="tich-container">
            ...
            <div class="tich-flex-wrap tich-mt-6">
                @auth
                    <span class="tich-btn tich-btn-secondary" style="background: white; color: var(--tich-green);">
                        Signed in as {{ auth()->user()->username }}
                    </span>
                @else
                    <a href="{{ route('login') }}" class="tich-btn tich-btn-secondary">Sign in to portal</a>
                    <a href="{{ route('register') }}" class="tich-btn tich-btn-outline-white">Create account</a>
                @endauth
            </div>
        </div>
    </section>
    ...
    <section class="tich-section">
        <div class="tich-container">
            ...
            <div class="tich-grid tich-grid--4">
                <div class="tich-card">
                    <div class="tich-card__icon tich-icon tich-icon--accent-green">
                ...
                <div class="tich-card">
                    <div class="tich-card__icon tich-icon tich-icon--accent-blue">
                        <svg class="h-5 w-5" viewBox="0 0 24 24" width="20" height="20">
                ...
                <div class="tich-card">
                    <div class="tich-card__icon tich-icon tich-icon--muted">
                        <svg class="h-5 w-5" viewBox="0 0 24 24" width="20" height="20">
            ...
            <div class="tich-grid tich-grid--2" style="gap: 2rem; align-items: start;">
                ...
                <div class="tich-grid tich-grid--2">
                    @foreach ([
                        ...
                        <div class="tich-stat">
                            <p class="tich-caption">{{ $stat['label'] }}</p>
                            <p class="tich-h3 tich-mt-2" style="color: var(--tich-grey); font-size: 1.125rem;">{{ $stat['value'] }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
